...
# transform x
toKeep = ["Distance", "OffenseFormation", "LineOfScrimmage", "Rusher_Gap_AveSpaceD",
          "Rusher_ADef", "Rusher_Acc", "Rusher_DistDef", "Rusher_DistDefMean", "Rusher_DistLOS",
          "Rusher_Gap_DistDirLOS", "Rusher_Gap_NPlayersD", "Rusher_Gap_Radius",
